-- CreateEnum
CREATE TYPE "GameStatusEnum" AS ENUM ('JOINING', 'PLAYING', 'END_ROUND', 'EVALUATION', 'SCORE_VIEWING', 'END_QUIZ');
...
-- AddForeignKey
ALTER TABLE "Topic" ADD CONSTRAINT "Topic_gameStatusId_fkey" FOREIGN KEY ("gameStatusId") REFERENCES "GameStatus"("id") ON DELETE SET NULL ON UPDATE CASCADE;
